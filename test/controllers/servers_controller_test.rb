...
class ServersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create server" do
    assert_difference('Server.count') do
      post servers_url, params: { server: { environment_id: @server.environment_id, name: @server.name } }
    end
  ...
  test "should update server" do
    patch server_url(@server), params: { server: { environment_id: @server.environment_id, name: @server.name } }
